...
//  --------------------------------------------------------------------------------
	...
	void push_back(int value)
	{
		if (m_size == m_capacity)
		{
			...
			delete[] std::exchange(m_array, new_array);
...
//  --------------------------------------
    ...
    std::cout << "Vector_1 capacity: " << vector_1.capacity() << ", size :" << vector_1.size() << "\n";

    vector_1.push_back(4);
    vector_1.push_back(5);

    std::cout << "After push_back(), Vector_1 capacity: " << vector_1.capacity() << ", size :" << vector_1.size() << "\n";

    vector_1.clear();

    std::cout << "After clear(), Vector_1 capacity: " << vector_1.capacity() << ", size :" << vector_1.size() << "\n";

    std::cout << "Vector_1 is empty: " << vector_1.empty() << "\n";
