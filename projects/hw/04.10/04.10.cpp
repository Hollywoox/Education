...
private :
    ...
    static constexpr bool current_match = std::is_same_v<current_t, T>;

    static constexpr bool rest_has = Has<T, pop_front<D>>::value;

public :

    static constexpr bool value = current_match || rest_has;
};
...
//  ------------------------------------------------------------------------------------------
    ...
    static_assert(has_v<int, Deque<double>> == false);

    static_assert(has_v<int, Deque<int, double>> == true);

    static_assert(has_v<double, Deque<int, double>> == true);
